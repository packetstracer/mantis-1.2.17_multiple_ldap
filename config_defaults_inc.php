...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	/*******************
 	 ...
 	 */
 	 ...
 	 $g_auth_profiles = array (
 		...
 		"1"  => array(
 			"auth_profile_name" 		=> "Name 1",
 			"login_method"				=> LDAP,
 			"ldap_server" 				=> "ldap://yourserver1",
 			"ldap_port" 				=> "389",
 			"ldap_root_dn"				=> "your_root_dn",
 			"ldap_organization"			=> "",
 			"ldap_uid_field"			=> "sAMAccountName",
 			"ldap_realname_field"		=> "cn",
 			"ldap_bind_dn"				=> "your_bind_user_dn",
 			"ldap_bind_passwd"			=> "your_bind_user_password",
 			"ldap_email"				=> OFF,
 			"ldap_realname"				=> OFF,
 		...
 		"2"  => array(
 			"auth_profile_name" 		=> "Name 2",
 			"login_method"				=> LDAP,
 			"ldap_server" 				=> "ldap://yourserver2",
 			"ldap_port" 				=> "389",
 			"ldap_root_dn"				=> "your_root_dn_2",
 			"ldap_organization"			=> "",
 			"ldap_uid_field"			=> "sAMAccountName",
 			"ldap_realname_field"		=> "cn",
 			"ldap_bind_dn"				=> "your_bind_user_dn_2",
 			"ldap_bind_passwd"			=> "your_bind_user_password_2",
 			"ldap_email"				=> OFF,
 			"ldap_realname"				=> OFF,
 			"ldap_protocol_version"		=> "3",
 			"ldap_follow_referrals"		=> OFF,
	...
	/**
	 *
	 * @global string $g_logon_to_cookie
	 */
    ...
    $g_top_include_page             = 'FEGA/prueba_logo.html';
...
#    $g_main_menu_custom_options = array();
    $g_main_menu_custom_options = array( array( "Calidad",  VIEWER, 'calidadPendientes.php' ) );
	 ...
	 */
	////7777: LDAP PATCH: copiamos la confiuración del valor anterior
	$g_display_errors = array(
		E_WARNING => 'inline',
		E_NOTICE => 'inline',
		E_USER_ERROR => 'halt',
	 ...
	 */
	$g_log_destination = 'file:/usr/share/ConTis/mantis.log';

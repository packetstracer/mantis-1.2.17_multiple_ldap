...
////7777: LDAP Patch: añadimos este include porque en pre da error si no
require_once( dirname( __FILE__ ) . DIRECTORY_SEPARATOR . 'user_api.php' );
 ...
 * @access public
 */
////7777: LDAP Patch: añadimos parámetro de identificador de servidor
////function auth_attempt_login( $p_username, $p_password, $p_perm_login = false ) {
function auth_attempt_login( $p_username, $p_password, $p_perm_login = false, $p_logon_to = false ) {
////7777//
	...
	if ( false === $t_user_id ) {
		...
		////7777: LDAP Patch: añadimos el tipo mixed login
		else if (MIXED == $t_login_method && ldap_authenticate_by_username( $p_username, $p_password, $p_logon_to)) {
			$t_auto_create = true;
		}
		////7777//
		else {
...
// 			return false;
// 		}
		if( !auth_does_password_match( $t_user_id, $p_password, $p_logon_to ) ) {
			user_increment_failed_login_count( $t_user_id );
			return false;
		}
		////7777//
 ...
 * @access public
 */
////7777: LDAP Patch: añadimos el parametro del servidor ldap
////function auth_does_password_match( $p_user_id, $p_test_password ) {
function auth_does_password_match( $p_user_id, $p_test_password, $p_logon_to = false ) {
////7777//
	...
	else if( MIXED == $t_configured_login_method ) {
		return ldap_authenticate( $p_user_id, $p_test_password, $p_logon_to );
	}
	////7777//
